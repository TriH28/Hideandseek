...
# Game settings
HIDING_TIME = 15  # seconds
SEEKING_TIME = 30  # seconds
...
# Load Seeker animations
seekerD1 = pygame.image.load("/Users/huuhuynh/Desktop/Năm 2 kì 2/Trí tuệ nhân tạo/HideAndSeek/Image/Sur/SurD1.png").convert_alpha()
seekerD2 = pygame.image.load("/Users/huuhuynh/Desktop/Năm 2 kì 2/Trí tuệ nhân tạo/HideAndSeek/Image/Sur/SurD2.png").convert_alpha()
seekerU1 = pygame.image.load("/Users/huuhuynh/Desktop/Năm 2 kì 2/Trí tuệ nhân tạo/HideAndSeek/Image/Sur/SurU1.png").convert_alpha()
seekerU2 = pygame.image.load("/Users/huuhuynh/Desktop/Năm 2 kì 2/Trí tuệ nhân tạo/HideAndSeek/Image/Sur/SurU2.png").convert_alpha()
seekerLR1 = pygame.image.load("/Users/huuhuynh/Desktop/Năm 2 kì 2/Trí tuệ nhân tạo/HideAndSeek/Image/Sur/SurLR1.png").convert_alpha()
seekerLR2 = pygame.image.load("/Users/huuhuynh/Desktop/Năm 2 kì 2/Trí tuệ nhân tạo/HideAndSeek/Image/Sur/SurLR2.png").convert_alpha()
seeker_idle = pygame.image.load("/Users/huuhuynh/Desktop/Năm 2 kì 2/Trí tuệ nhân tạo/HideAndSeek/Image/Sur/SurS.png").convert_alpha()


# Load buttons
play_button = pygame.image.load("/Users/huuhuynh/Desktop/Năm 2 kì 2/Trí tuệ nhân tạo/HideAndSeek/Image/Button/play.png").convert_alpha()
play_button = pygame.transform.scale(play_button, (200, 50))
rule_button = pygame.image.load("/Users/huuhuynh/Desktop/Năm 2 kì 2/Trí tuệ nhân tạo/HideAndSeek/Image/Button/rule.png").convert_alpha()
rule_button = pygame.transform.scale(rule_button, (200, 50))
settings_button = pygame.image.load("/Users/huuhuynh/Desktop/Năm 2 kì 2/Trí tuệ nhân tạo/HideAndSeek/Image/Button/Set.png").convert_alpha()
settings_button = pygame.transform.scale(settings_button, (200, 50))
...
def draw_main_menu():
    ...
    # Draw buttons
    play_rect = DISPLAYSURF.blit(play_button, (DISPLAYSURF.get_width()//2 - play_button.get_width()//2, 250))
    rules_rect = DISPLAYSURF.blit(rule_button, (DISPLAYSURF.get_width()//2 - rule_button.get_width()//2, 320))
    settings_rect = DISPLAYSURF.blit(settings_button, (DISPLAYSURF.get_width()//2 - settings_button.get_width()//2, 390))
...
while True:
    ...
    for event in pygame.event.get():
        ...
        if event.type == MOUSEBUTTONDOWN and game_state == MAIN_MENU:
            mouse_pos = event.pos
            ...
            if play_rect.collidepoint(mouse_pos):
                ...
                # Add rules screen implementation here
                pass
            elif settings_rect.collidepoint(mouse_pos):
                # Add settings screen implementation here
                pass
